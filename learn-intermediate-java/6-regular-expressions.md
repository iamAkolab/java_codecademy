...
Alternation is also found implicitly in character 
classes
Preview: Docs Loading link description
. For instance, a character class like [A-Z] grabs a range of characters. This is the equivalent of grabbing A OR B OR C and so on.
